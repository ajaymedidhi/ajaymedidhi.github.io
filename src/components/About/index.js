  ...
  <>
    <div className="about-us">
      ...
      <p>
        ...
        also automates much of the legal process in real estate transactions by
        using AI to automate tasks such as document review, contract
        negotiation, and financial analysis.
      </p>
      <p>
        Proptelligence is a World Leading Data-Driven company using PropTech and
        Legal Tech. We provide smart solutions for companies of all sizes and
        pride ourselves on our unparalleled, dedicated service. At
      ...
      <p>
        ...
        Science, Cloud, and Digital Platforms. We are a technology company that
        is developing AI for the legal and real estate sectors.
      </p>
    </div>
  </>
)
